...
- 120 files · ~22,469 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 759 nodes · 844 edges · 95 communities (83 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness

- Built from commit: `3715715b`
...
Cohesion: 0.23
Nodes (10): AppError, ErrorCode, STATUS_TO_CODE, errorHandler(), ErrorResponse, handleJwtExpiredError(), handleJwtInvalidError(), allowedOrigins (+2 more)
...
Cohesion: 0.29
Nodes (6): UserService, FreelancerOnboardingInput, freelancerOnboardingSchema, ErrorBody, sendSuccess(), SuccessResponse

### Community 135 - "Community 135"

Cohesion: 0.31
Nodes (5): getMe, router, Auth, AsyncHandler, catchAsync()
