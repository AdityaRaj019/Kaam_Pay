# Graph Report - kaampay  (2026-09-17)

## Corpus Check
- 138 files · ~35,072 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1089 nodes · 1276 edges · 122 communities (111 shown, 11 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `788be5d3`
...
5. `══════════════════════════════════════════════════════════════` - 13 edges
6. `══════════════════════════════════════════════════════════════` - 13 edges
7. `ErrorCode` - 11 edges
8. `hiddenItems` - 11 edges
9. `🖥️ FRONTEND — Next.js (App Router)` - 11 edges
10. `6. Functional Requirements` - 11 edges
...
Cohesion: 0.28
Nodes (9): 2.1 Problem Description, 2.2 Impact Analysis, 2.3 Expected Outcomes, 2. Problem Statement, ══════════════════════════════════════════════════════════════, ══════════════════════════════════════════════════════════════, Document Control, Revision History (+1 more)
...
Cohesion: 0.14
Nodes (25): BookmarkBtn(), BookmarkBtnProps, DEFAULT_FILTERS, FilterDrawer(), FilterDrawerProps, Filters, FullModal(), FullModalProps (+17 more)
...
Cohesion: 0.22
Nodes (10): AppError, ErrorCode, STATUS_TO_CODE, errorHandler(), ErrorResponse, handleJwtExpiredError(), handleJwtInvalidError(), OrderService (+2 more)
...
Cohesion: 0.17
Nodes (12): router, Auth, authorize(), requireAuth(), router, createOrder, router, allowedOrigins (+4 more)
...
## Knowledge Gaps
- **622 isolated node(s):** `eslintConfig`, `nextConfig`, `name`, `version`, `private` (+617 more)
