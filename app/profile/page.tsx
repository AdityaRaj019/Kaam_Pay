          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            ...
            <div className="lg:col-span-1 bg-white rounded-3xl border border-slate-200 p-6 shadow-sm flex flex-col space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <svg
                        className="w-4 h-4 text-slate-600 group-hover:text-[#4a4bd7] fill-current shrink-0"
                        viewBox="0 0 24 24"
                      >
                    ...
                    <span className="text-[10px] text-slate-400 group-hover:text-[#4a4bd7] truncate max-w-[120px]">
                      {user.profile?.portfolioLinks?.[1]
                        ? user.profile.portfolioLinks[1].replace(
                  ...
                  >
                    ...
                    <span className="text-[10px] text-slate-400 group-hover:text-[#4a4bd7]">
                  ...
                  >
                    ...
                    <span className="text-[10px] text-slate-400 group-hover:text-[#4a4bd7] truncate max-w-[120px]">
                      {user.profile?.portfolioLinks?.[0]
                        ? user.profile.portfolioLinks[0].replace(/^https?:\/\/(www\.)?/, '')
                        : 'portfolio.dev'}
                    </span>
                  </a>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4 border-t border-slate-100 pt-3 text-xs mt-auto">
                ...
                <div>
                  <span className="text-slate-450 font-bold block uppercase text-[9px] tracking-wider">
                    Response Time
                  </span>
