    ...
    <>
      <div className="w-full max-w-6xl flex justify-between items-center mb-4">
        ...
        <div className="hidden sm:block text-sm">
          ...
          <Link
            href={isClient ? '/register?role=freelancer' : '/register?role=client'}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="flex flex-col sm:flex-row gap-5">
            <div className="flex-1">
              ...
              <input
                ...
                className="w-full px-4 py-2.5 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-900 focus:border-blue-900 outline-none"
              />
            </div>
            <div className="flex-1">
          ...
          <div className="space-y-4 pt-2">
            <label className="flex items-start gap-3 cursor-pointer">
              <input
                type="checkbox"
                className="mt-1 w-4 h-4 text-green-600 rounded border-gray-300 focus:ring-green-600"
              />
